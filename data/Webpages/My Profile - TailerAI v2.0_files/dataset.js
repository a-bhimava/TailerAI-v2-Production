...
async function handleWorkExperienceSubmit(event) {
    ...
    try {
        ...
        const response = await window.api.post('/api/v2/master-dataset/experience', data);
...
async function handleAchievementSubmit(event) {
    ...
    try {
        ...
        if (experienceId) {
            await window.api.post(`/api/v2/master-dataset/experience/${experienceId}/achievement`, data);
        } else {
            await window.api.post('/api/v2/master-dataset/achievement', data);
        }
...
async function handleEducationSubmit(event) {
    ...
    try {
        ...
        const response = await window.api.post('/api/v2/master-dataset/education', data);
...
async function handleProjectSubmit(event) {
    ...
    try {
        ...
        // Add project via API
        const response = await window.api.post('/api/v2/master-dataset/projects', data);
