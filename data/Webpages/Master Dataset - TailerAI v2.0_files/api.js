...
class APIClient {
    ...
    async createWorkExperience(experienceData) {
        return this.post('/api/v2/master-dataset/work-experiences', experienceData);
    }

    async updateWorkExperience(experienceId, experienceData) {
        return this.put(`/api/v2/master-dataset/work-experiences/${experienceId}`, experienceData);
    }

    async deleteWorkExperience(experienceId) {
        return this.delete(`/api/v2/master-dataset/work-experiences/${experienceId}`);
    }

    async createAchievement(achievementData) {
        return this.post('/api/v2/master-dataset/achievements', achievementData);
    }

    async updateAchievement(achievementId, achievementData) {
        return this.put(`/api/v2/master-dataset/achievements/${achievementId}`, achievementData);
    }

    async deleteAchievement(achievementId) {
        return this.delete(`/api/v2/master-dataset/achievements/${achievementId}`);
    }
    ...
    async createSkill(skillData) {
        return this.post('/api/v2/master-dataset/skills', skillData);
    }
